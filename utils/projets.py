    ...
    return [
        {
            ...
            "tools": ["En groupe - Ecole", "Java", "SpringBoot", "Angular","Neon PostGre"],
            "links": [
            ...
            "details_text": [
                ...
                "Page d'accueil après connexion, avec un accès au profil, barre de recherche, la liste des événements et de création d'événements",
                "Page profil qui rappelle les données du compte, avec un accès sur les événements inscrits ou créés",
                "Répertoire de toutes les catégories d'événements",
                "Liste de tous les événements existants",
                "Interface permettant de créer un nouvel événement",
                "Page de présentation d'un événement"
            ]
        },
        {
            "title": "Dauphairline",
            "description": "JUIN 2025 | Site de gestion des réservations des vols d'avion | Création, génération, recherche de vol avec enregistrement d'embarquement, siège, check-in, bagage",
